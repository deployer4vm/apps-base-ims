        ...
        <div class="table-responsive">
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr v-for="(file, index) in intFiles" :key="file.id" :class="{'table-danger':index==0 && firstFileAsCover?true:false}">
                        <td>{{ index+1 }}</td>
                        <td>
                        ...
                        <td>
                            <div class="filename">
                                <a v-b-tooltip.hover.top :title="'View file'"  :href="intUploadUrl + file.filepath" target="_blank">{{ file.name }} <span class="ml-2 ion ion-md-open"></span></a>
                                <div v-if="firstFileAsCover && index==0"><b>[COVER IMAGE]</b></div>
                            </div>
                        ...
                        <td v-if="!disabled">
                            <template v-if="canMovePos">
                                <b-btn @click="imageMoveUp(index)" variant="info btn-xs" title="Move Up">
                                    <i class="ion ion-ios-arrow-up" aria-hidden="true"></i>
                                </b-btn>
                                <b-btn @click="imageMoveDown(index)" variant="info btn-xs" title="Move Down">
                                    <i class="ion ion-ios-arrow-down" aria-hidden="true"></i>
                                </b-btn>
                            </template>
                            <b-btn @click="imageDelete(index)" variant="danger btn-xs" title="Delete Image">
                                <i class="ion ion-md-close" aria-hidden="true"></i>
                            </b-btn>
                        </td>
                    </tr>
                </tbody>
