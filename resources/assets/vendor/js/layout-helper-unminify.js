        ...
        258: function (t, e, n) {
            ...
            var r = {
                ...
                _bindSidenavMouseEvents: function () {
                    ...
                    if (!(this._sidenavMouseEnter && this._sidenavMouseLeave && this._windowTouchStart)) {
                        ...
                        this._sidenavMouseEnter ||
                            ...
                            e.addEventListener("mouseenter", this._sidenavMouseEnter, !1),
                            e.addEventListener("touchstart", this._sidenavMouseEnter, !1)),
                            this._sidenavMouseLeave ||
                                ((this._sidenavMouseLeave = function () {
                                    t._setSidenavHoverState(!1);
                                }),
                                e.addEventListener("mouseleave", this._sidenavMouseLeave, !1)),
                ...
                _unbindSidenavMouseEvents: function () {
                    if (this._sidenavMouseEnter || this._sidenavMouseLeave || this._windowTouchStart) {
                        var t = this.getLayoutSidenav();
                        this._sidenavMouseEnter && (t && (t.removeEventListener("mouseenter", this._sidenavMouseEnter, !1), t.removeEventListener("touchstart", this._sidenavMouseEnter, !1)), (this._sidenavMouseEnter = null)),
                            this._sidenavMouseLeave && (t && t.removeEventListener("mouseleave", this._sidenavMouseLeave, !1), (this._sidenavMouseLeave = null)),
                            this._windowTouchStart && (t && window.addEventListener("touchstart", this._windowTouchStart, !0), (this._windowTouchStart = null)),
                            this._setSidenavHoverState(!1);
                    }
                },
                    ...
                    i &&
                        ...
                        n && this._supportsTransitionEnd()
                            ? (this._addClass("layout-transitioning"),
                              e && this._setSidenavHoverState(!1),
                ...
                setPosition: function () {
                    ...
                    this._removeClass("layout-offcanvas layout-fixed layout-fixed-offcanvas"),
                        !t && e ? this._addClass("layout-offcanvas") : t && !e ? (this._addClass("layout-fixed"), this._redrawLayoutSidenav()) : t && e && (this._addClass("layout-fixed-offcanvas"), this._redrawLayoutSidenav()),
                        this.update();
                },
                ...
                update: function () {
                    ((this.getLayoutNavbar() && ((!this.isSmallScreen() && this.isLayout1() && this.isFixed()) || this.isNavbarFixed())) || (this.getLayoutFooter() && this.isFooterFixed())) &&
                        this._updateInlineStyle(this._getNavbarHeight(), this._getFooterHeight()),
                        this._bindSidenavMouseEvents();
                },
                setAutoUpdate: function () {
                    var t = this,
                        e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : s("enable");
                    e && !this._autoUpdate
                        ? (this.on("resize.layoutHelpers:autoUpdate", function () {
                              return t.update();
                          }),
                          (this._autoUpdate = !0))
                        : !e && this._autoUpdate && (this.off("resize.layoutHelpers:autoUpdate"), (this._autoUpdate = !1));
                },
                on: function () {
            ...
            "undefined" != typeof window &&
                (r.init(),
                r.isMobileDevice() && window.chrome && document.documentElement.classList.add("layout-sidenav-100vh"),
