...
if(!empty($system['multiproject']['active']) && file_exists(__DIR__ . '/../app/MainApp/Projects/'.$client['project_code'].'/config/packageLocal.json')){
...
if(!empty($system['multitenant']['active'])){

    $tenantPath = base_path(empty($system['multiproject']['active'])?
...
// jika multi tenan maka loop vue router module2 di masing2 tenant
...
if(isset($system['multitenant']['active']) && $system['multitenant']['active']){
    ...
    $tenantPath = (isset($system['multiproject']['active']) && $system['multiproject']['active'])?
        (__DIR__ . '/../app/MainApp/Projects/'.$client['project_code'].'/Tenants/*/Modules/*/resources/js/router/index.js'):
        (__DIR__ . '/../app/MainApp/Tenants/*/Modules/*/resources/js/router/index.js');
    $tenantList = glob($tenantPath);
