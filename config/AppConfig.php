...
if(isset($system['multiproject']['active']) && $system['multiproject']['active'] && file_exists(__DIR__ . '/../app/MainApp/Projects/'.$client['project_code'].'/config/packageLocal.json')){
    ...
    */
    ...
    if($packageLocal[$item['package_namespace']]['enable'] ){
        ...
        if (file_exists($filePath."resources/js/store/storeConfig.js")) {
            $moduleStoreConfig[] = "import ".$item['package_namespace'].' from "'.$packagePath.'resources/js/store/storeConfig";' . "\n";
...
if(isset($system['multitenant']['active']) && $system['multitenant']['active']){
     ...
     */
    $tenantPath = base_path((isset($system['multiproject']['active']) && $system['multiproject']['active'])?
        ('app/MainApp/Projects/'.$client['project_code'].'/Tenants/*/Modules/*/resources/js/router/indexAdmin.js'):
     ...
     */
    $tenantPath = base_path((isset($system['multiproject']['active']) && $system['multiproject']['active'])?
        ('app/MainApp/Projects/'.$client['project_code'].'/Tenants/*/Modules/*/resources/js/router/index.js'):
    ...
    if($tenantList){
        foreach ($tenantList as $path) {
            ...
            if(!isset($moduleRouterNamespacePerTenant[$tenantData[0]]))$moduleRouterNamespacePerTenant[$tenantData[0]] = [];
...
if($system['web_admin']['full_vue']){
    $moduleBuildJs[] = "};";
    file_put_contents(__DIR__ . '/../app/MainApp/resources/js/build.js', implode('',$moduleBuildJs));
}

if($system['web_admin']['web']){
    $moduleWebBuildJs[] = "};";
    file_put_contents(__DIR__ . '/../app/MainApp/resources/js/webBuild.js', implode('',$moduleWebBuildJs));
}
...
file_put_contents(__DIR__ . '/../app/MainApp/resources/js/store/storeConfig.js', implode('',$moduleStoreConfig)."\nconst storeConfig = {\n".implode(",\n",$moduleStoreConfigNamespace)."\n};\n\nexport default storeConfig;" );
...
// per tenant
file_put_contents(__DIR__ . '/../app/MainApp/resources/js/store/modulesPerTenant.js', implode('',$moduleStorePerTenant)."\nconst store = {\n".implode(",\n",$moduleStoreNamespacePerTenant)."\n};\n\nexport default store;" );
file_put_contents(__DIR__ . '/../app/MainApp/resources/js/store/storeConfigPerTenant.js', implode('',$moduleStoreConfigPerTenant)."\nconst store = {\n".implode(",\n",$moduleStoreConfigNamespacePerTenant)."\n};\n\nexport default storeConfig;" );
file_put_contents(__DIR__ . '/../app/MainApp/resources/js/router/modulesPerTenant.js', implode('',$moduleRouterPerTenant)."\nvar routes = {\n".implode(",\n",$moduleRouterNamespacePerTenant)."};\n\nexport default routes;" );
file_put_contents(__DIR__ . '/../app/MainApp/resources/js/router/modulesAdminPerTenant.js', implode('',$moduleRouterAdminPerTenant)."\nvar routes = {\n".implode(",\n",$moduleRouterAdminNamespacePerTenant)."};\n\nexport default routes;" );
...
file_put_contents(__DIR__ . '/../app/MainApp/config/_packageLocalPertenant.json', json_encode($packageLocalPerTenant, JSON_PRETTY_PRINT));
